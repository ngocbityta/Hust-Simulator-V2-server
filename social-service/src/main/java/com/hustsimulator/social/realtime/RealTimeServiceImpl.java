package com.hustsimulator.social.realtime;

import com.corundumstudio.socketio.SocketIOServer;
import com.hustsimulator.social.entity.Message;
import com.hustsimulator.social.message.MessageService;
    ...
    public void initListeners() {
        server.addConnectListener(client -> {
            ...
            if (userIdStr != null) {
                ...
                String personalRoom = "user_" + userIdStr;
                client.joinRoom(personalRoom);
                log.info("Client {} joined personal room: {}", client.getSessionId(), personalRoom);
            }
        ...
        server.addEventListener("class:message", Object.class, (client, data, ackRequest) -> {
            ...
            try {
                ...
                com.hustsimulator.social.enums.MessageType type = com.hustsimulator.social.enums.MessageType.TEXT;
                try {
                    type = com.hustsimulator.social.enums.MessageType.valueOf(typeStr.toUpperCase());
