...
public class FirebaseStorageProvider implements StorageProvider {
    ...
    public String upload(String originalName, String fileType, byte[] data) {
        try {
            ...
            // Generate standard Firebase Storage public download URL without tokens
            // (assumes bucket is readable)
            // Or a Firebase generic URL:
            // https://firebasestorage.googleapis.com/v0/b/<bucket>/o/<encoded_file_name>?alt=media
