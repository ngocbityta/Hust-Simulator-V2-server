...
interface ComputationService {
    ...
    processUserStateChange(data: any): Observable<{ success: boolean; message: string }>;
}
...
export class GrpcComputationClient implements OnModuleInit {
    ...
    onModuleInit() {
        this.computationService = this.client.getService<ComputationService>('ComputationService');
